...
class TestHazardSystem(unittest.TestCase):
    ...
    def test_bomb_explodes_after_fuse(self):
        hs = HazardSystem(world_size=(800, 600), sprite_root="images/Space-Shooter_objects", config={"enabled": True})
    ...
    def test_meteor_split_on_destroy(self):
        sprites = HazardSpriteLibrary("images/Space-Shooter_objects")
